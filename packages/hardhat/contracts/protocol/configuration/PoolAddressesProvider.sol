...
contract PoolAddressesProvider is Ownable, IPoolAddressesProvider {
  ...
  function setPoolConfigurator(address newConfigurator) external onlyOwner {

  address oldConfigurator =_addresses[POOL_CONFIGURATOR];
  _addresses[POOL_CONFIGURATOR] = newConfigurator;

  emit PoolConfiguratorUpdated(oldConfigurator,newConfigurator);
  }
